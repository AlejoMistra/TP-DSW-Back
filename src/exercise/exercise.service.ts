...
import {CreateExerciseInput, ExerciseResponse, ExerciseResponseSchema, UpdateExerciseInput} from './exercise.schemas.js';
...
export class ExerciseService {
    ...
    async update(id: number, props: UpdateExerciseInput): Promise<PropiedadesExercise | null> {
